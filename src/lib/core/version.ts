...
export const VERSION_HISTORY: ReadonlyArray<{
  ...
  { version: '2.4.0', date: '2026-04-30', highlights: ['AI Unleashed', 'SOLO Bridge 真实实现', '7 AI 事件处理器', 'Email + WebPush 真实推送', 'Webhook 重试 + GitHub 触发器', '通知管理页面', '3 示例插件', '162+ MCP 工具', '1875 测试'] },
